    ...
    return (
        <div className="w-full md:max-w-1/2">
            ...
            <motion.a
                ...
                className="flex justify-center items-center font-medium mt-4 mx-auto w-36 h-9 bg-primaryGreen px-3 rounded-sm cursor-pointer md:mx-0 hover:bg-background hover:text-white hover:border hover:border-primaryGreen duration-500">
                Download CV
            </motion.a>
            {children}
        </div>
